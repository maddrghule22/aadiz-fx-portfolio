...
export default function ContactPage() {
  ...
  const handleWhatsAppSubmit = (e: React.FormEvent) => {
    ...
    const whatsappURL = generateContactWhatsAppURL(formData)
    window.open(whatsappURL, '_blank')
    
    setSubmitStatus({ 
      type: 'success', 
      message: 'Opening WhatsApp with your message. Please send the message to complete your submission.' 
    })
  }
          ...
          >
            ...
            >
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="heading-xs text-neutral-100 mb-1">WhatsApp</h3>
                  <p className="body-md text-neutral-300">
                    <a href="https://wa.me/918180999435" target="_blank" rel="noopener noreferrer" className="text-accent-500 hover:underline">
                      +91 81809 99435
                    </a>
                  </p>
                  <p className="text-sm text-neutral-400 mt-1">Click to message directly on WhatsApp</p>
                </div>
              </div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  ...
                  className="flex-1 bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-300 flex items-center justify-center"
                >
